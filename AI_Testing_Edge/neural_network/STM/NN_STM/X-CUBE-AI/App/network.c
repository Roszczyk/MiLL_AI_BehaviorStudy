...
#define AI_NETWORK_MODEL_SIGNATURE     "0xe8e12dc0667cb296feaf8815e546a43e"
...
#define AI_TOOLS_DATE_TIME   "2024-12-29T19:04:59+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 40, 4, 1, 1), AI_STRIDE_INIT(4, 4, 160, 640, 640),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 11, 120, 1, 1), AI_STRIDE_INIT(4, 4, 44, 5280, 5280),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 120, 40, 1, 1), AI_STRIDE_INIT(4, 4, 480, 19200, 19200),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 25776, 1, 1),
    25776, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_layer0_output_array.data = AI_PTR(g_network_activations_map[0] + 116);
    serving_default_input_layer0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 116);
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 160);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 160);
    nl_0_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 160);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 160);
    ...
    nl_2_output_array.data = AI_PTR(g_network_activations_map[0] + 160);
    nl_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 160);
    ...
    nl_4_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    nl_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 5280);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5280);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 5760);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5760);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 24960);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 24960);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 25120);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 25120);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 25760);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 25760);
    return true;
  }
